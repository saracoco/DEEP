...
from prepare_data_and_model import AttentionUNet, plot_learning_curves, display_test_sample, save_image
...
model = AttentionUNet()
model.load_state_dict(torch.load('results/attention_unet.pth'))

display_test_sample(model, test_input, test_target, device)

# name your Pdf file  CHANGE WITH APPROPRIATE NAME
filename = "plots/multi_plot_image_Attention_UNet.pdf" 
